...
class SentimentController(object):
    ...
    def create_return_english_general_sentiment_plaintext(self,
                                                          body):
        """Does a POST request to /sentiment.
    ...
    def create_return_english_general_sentiment_multipart_form(self,
                                                               text):
        """Does a POST request to /sentiment.
    ...
    def create_return_english_general_sentiment_encoded_form(self,
                                                             text):
        """Does a POST request to /sentiment.

        Return the sentiment of an English text supplied in an encoded form
        using key 'text'.

        Args:
            text (string): Supply the text to be classified.
