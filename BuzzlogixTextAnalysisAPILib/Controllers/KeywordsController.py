...
class KeywordsController(object):
    ...
    def create_return_english_keywords_text_plain(self,
                                                  body):
    ...
    def create_return_english_keywords_multipart_form_data(self,
                                                           text):
        """Does a POST request to /keywords.
    ...
    def create_return_english_keywords_x_www_form_urlencoded(self,
                                                             text):
        """Does a POST request to /keywords.
